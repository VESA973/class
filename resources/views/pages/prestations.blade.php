...
@section('content')
    <section class="page-hero">
        ...
        <h1>Vos évènements, nos chauffeurs.</h1>
        <p>Choisissez de faire appel à nous pour tous types d'évènements comme les mariages, les transferts, les soirées et bien d'autres.</p>
    </section>
        ...
        <div class="prestation-carousel" data-prestation-carousel>
            <div class="carousel-head">
                ...
                <div class="carousel-actions">
                    <button type="button" aria-label="Prestation précédente" data-carousel-prev>
